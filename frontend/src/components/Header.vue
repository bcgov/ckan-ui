                    ...
                    <v-menu bottom left offset-y color="secondary" transition="slide-y-transition" min-width="320px">
                        ...
                        <!-- <v-row justify-left fill-height class="secondary_color">
                            ...
                            <v-col cols=12 class="primary_color gov-yellow-border-top"> -->
                                ...
                                <v-list-item v-if="this.$i18n.locale != 'en'" left fixed color="text" id="mobile-english-btn" @click="setLanguage('en')">{{$tc('Language')}}: English</v-list-item>
                                <v-list-item v-if="this.$i18n.locale != 'fr'" left fixed color="text" id="mobile-french-btn" @click="setLanguage('fr')">{{$tc('Language')}}: Français</v-list-item>
                                </v-list>
                            <!-- </v-col>
                        </v-row> -->
                    </v-menu>
