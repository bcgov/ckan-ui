export default {
    en: {
        ...
        "Open Standard Data": "Open Standard Data",
        "JavaScript Object Notation standard data file": "JavaScript Object Notation standard data file",
        "OpenAPI that returns data in JSON format": "OpenAPI that returns data in JSON format",
        "Geospatial Data": "Geospatial Data",
        "ArcGIS REST API": "ArcGIS REST API",
        "ESRI ArcInfo interchange file": "ESRI ArcInfo interchange file",
        "ESRI File Geodatabase format": "ESRI File Geodatabase format",
        "Open standard format representing simple geographical features": "Open standard format representing simple geographical features",
        "Google Earth file": "Google Earth file",
        "Keyhole Markup Language" :"Keyhole Markup Language",
